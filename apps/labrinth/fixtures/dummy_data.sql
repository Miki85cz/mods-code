...
VALUES ({{user_id::ADMIN}},     'Admin',     'admin@cosmods.miki85.cz',     'admin'),
       ({{user_id::MODERATOR}}, 'Moderator', 'moderator@cosmods.miki85.cz', 'moderator'),
       ({{user_id::USER}},      'User',      'user@cosmods.miki85.cz',      'developer'),
       ({{user_id::FRIEND}},    'Friend',    'friend@cosmods.miki85.cz',    'developer'),
       ({{user_id::ENEMY}},     'Enemy',     'enemy@cosmods.miki85.cz',     'developer');
...
VALUES (1, 1, 'https://cosmods.miki85.cz/oauth_callback');
