...
VALUES
	(
		...
		'https://cosmods.miki85.cz/email/payout-available',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'View your revenue dashboard: https://cosmods.miki85.cz/dashboard/revenue',
			CHR(10),
			CHR(10),
			'If you have any questions about the creator rewards program, please contact support through the Support Portal at https://support.cosmods.miki85.cz/ or by replying to this email.',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://cosmods.miki85.cz/email/personal-access-token-created',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'Support Portal: https://support.cosmods.miki85.cz/'
		)
	);
...
VALUES
	(
		...
		'https://cosmods.miki85.cz/email/moderation-thread-message-received',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			'Your project''s moderation thread: https://cosmods.miki85.cz/project/{project.id}/moderation',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://cosmods.miki85.cz/email/report-updated',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://cosmods.miki85.cz/email/report-submitted',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'If you have any additional information about this report, you can view it here: https://cosmods.miki85.cz/dashboard/report/{newreport.id}',
			CHR(10),
			CHR(10),
			'Thank you for helping keep Modrinth safe and welcoming for everyone.'
		)
...
VALUES
	(
		...
		'https://cosmods.miki85.cz/email/project-approved',
		CONCAT(
			...
			CHR(10),
			CHR(10),
			'View your project here: https://cosmods.miki85.cz/project/{project.id}',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://cosmods.miki85.cz/email/project-status-updated-neutral',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'View your project here: https://cosmods.miki85.cz/project/{project.id}/moderation',
			CHR(10),
			CHR(10),
...
VALUES
	(
		...
		'https://cosmods.miki85.cz/email/project-ownership-transferred',
		CONCAT(
			'Hi {user.name},',
			CHR(10),
			CHR(10),
			...
			CHR(10),
			CHR(10),
			'View the project here: https://cosmods.miki85.cz/project/{project.id}',
			CHR(10),
			CHR(10),
