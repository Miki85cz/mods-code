					...
					<Row class="mb-2 mt-0">
						<Column class="w-8">
							<Img
								...
								height="20"
								alt="Time icon"
								src="https://cdn-raw.cosmods.miki85.cz/email/earth.png"
							/>
						</Column>
						<Column>
					...
					<Row class="mb-2">
						<Column class="w-8">
							<Img
								...
								height="20"
								alt="Time icon"
								src="https://cdn-raw.cosmods.miki85.cz/email/monitor-smartphone.png"
							/>
						</Column>
						<Column>
					...
					<Row>
						<Column class="w-8">
							<Img
								...
								height="20"
								alt="Time icon"
								src="https://cdn-raw.cosmods.miki85.cz/email/clock.png"
							/>
						</Column>
						<Column>
