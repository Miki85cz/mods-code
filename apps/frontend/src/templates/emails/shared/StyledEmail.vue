...
const socialLinks = Object.freeze<readonly SocialLink[]>([
	{
		...
		alt: 'Discord',
		src: 'https://cdn-raw.cosmods.miki85.cz/email/discord.png',
	},
	{
		href: 'https://bsky.app/profile/cosmods.miki85.cz',
		alt: 'Bluesky',
		src: 'https://cdn-raw.cosmods.miki85.cz/email/bluesky.png',
	},
	{
		href: 'https://floss.social/@modrinth',
		alt: 'Mastodon',
		src: 'https://cdn-raw.cosmods.miki85.cz/email/mastodon.png',
	},
	{
		href: 'https://x.com/modrinth',
		alt: 'X (Twitter)',
		src: 'https://cdn-raw.cosmods.miki85.cz/email/x.png',
	},
	{
		href: 'https://www.instagram.com/modrinth/',
		alt: 'Instagram',
		src: 'https://cdn-raw.cosmods.miki85.cz/email/instagram.png',
	},
	{
		href: 'https://www.youtube.com/@modrinth',
		alt: 'YouTube',
		src: 'https://cdn-raw.cosmods.miki85.cz/email/youtube.png',
	},
	{
		href: 'https://github.com/modrinth',
		alt: 'GitHub',
		src: 'https://cdn-raw.cosmods.miki85.cz/email/github.png',
	},
])
</script>
...
<template>
	<StyledTemplate :title="title">
		<Section class="bg-bg pb-4 pl-4 pr-4 pt-4">
			<Container class="max-w-[600px]">
				<Row>
					<Column>
						<Img
							src="https://cdn.cosmods.miki85.cz/email/f740e2decee8764a4629bff677a284f9.png"
							width="29"
							alt=""
							class="block h-auto"
						/>
			...
			<Container class="max-w-[600px]">
				<Row>
					<Column class="align-middle">
						<VLink href="https://cosmods.miki85.cz" aria-label="Modrinth">
							<Img
								src="https://cdn.cosmods.miki85.cz/email/bd3357dfae4b1d266250372db3a0988f.png"
								width="175"
								alt="modrinth logo"
								class="block h-auto"
							/>
		...
		>
			...
			<VLink href="https://cosmods.miki85.cz/settings/notifications" class="text-green underline"
		...
		>
			...
			<Text class="text-2xs text-muted mt-0">
				...
				<!-- <span class="block break-words">
					...
					https://cosmods.miki85.cz/settings/notifications
				</span> -->
			</Text>
		</Section>
	</StyledTemplate>
