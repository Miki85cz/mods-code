...
const AD_PRESETS = {
	medal: {
		light: 'https://cdn-raw.cosmods.miki85.cz/modrinth-hosting-medal-light.webp',
		dark: 'https://cdn-raw.cosmods.miki85.cz/modrinth-hosting-medal-dark.webp',
		description: 'Host your next server with Modrinth Hosting',
		link: '/hosting?plan&ref=medal',
	},
	'modrinth-hosting': {
		light: 'https://cdn-raw.cosmods.miki85.cz/modrinth-hosting-light.webp',
		dark: 'https://cdn-raw.cosmods.miki85.cz/modrinth-hosting-dark.webp',
		description: 'Host your next server with Modrinth Hosting',
		link: '/hosting',
	},
}
