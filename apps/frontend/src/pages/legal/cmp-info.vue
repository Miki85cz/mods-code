<template>
	<div class="markdown-body">
		...
		<p>
			...
			<a href="https://cosmods.miki85.cz/dashboard/analytics">analytics dashboard</a>.
		</p>
		...
		<p>
			...
			>. We also have an
			<a href="https://api.cosmods.miki85.cz/v3/payout/platform_revenue">API route</a>
		...
		<small
			...
			aforementioned
			<a href="https://api.cosmods.miki85.cz/v3/payout/platform_revenue">API route</a>.</small
		>
	</div>
</template>
