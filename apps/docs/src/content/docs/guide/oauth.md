...
| Name               | URL                                              |
| ------------------ | ------------------------------------------------ |
| Authorization page | `https://cosmods.miki85.cz/auth/authorize`            |
| Token exchange     | `https://api.cosmods.miki85.cz/_internal/oauth/token` |
...
Once the user is ready to authorize your application, you need to construct a URL to redirect them to. The authorization URL for Modrinth is `https://api.cosmods.miki85.cz/_internal/oauth/token`. Supply the following query parameters:
...
[register an application]: https://cosmods.miki85.cz/settings/applications
...
[`/user` endpoint]: https://docs.cosmods.miki85.cz/api/operations/getuserfromauth/
[Discord guild]: https://discord.cosmods.miki85.cz
[support portal]: https://support.cosmods.miki85.cz/en/
