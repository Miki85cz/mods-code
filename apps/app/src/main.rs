...
fn main() {
    ...
    */
    ...
    tracing::info!("Initialized tracing subscriber. Loading CosMods App!");
            ...
            #[cfg(target_os = "windows")]
            {
                ...
                if format!("{e:?}").contains(
                    ...
                    DialogBuilder::message()
                        .set_level(MessageLevel::Error)
                        .set_title("Initialization error")
                        .set_text("Your Microsoft Edge WebView2 installation is corrupt.\n\nMicrosoft Edge WebView2 is required to run CosMods App.\n\nLearn how to repair it at https://support.cosmods.miki85.cz/en/articles/8797765-corrupted-microsoft-edge-webview2-installation")
                        .alert()
                        .show()
                        .unwrap();
