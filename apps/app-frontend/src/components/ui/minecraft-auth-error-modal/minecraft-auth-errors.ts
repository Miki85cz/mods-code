...
export const minecraftAuthErrors: MinecraftAuthError[] = [
	...
	},
	{
		...
		stepsToFix: [
			...
			'Make sure you are using the Microsoft account that owns Minecraft. See <a href="https://support.cosmods.miki85.cz/en/articles/9409136-finding-the-right-xbox-account">Finding the right Xbox account</a> for help',
