...
5. **Platform Revenue Route**
   ...
   Due to some unannounced breaking changes in Aditude's API, the platform revenue API was broken. It is now [working](https://api.cosmods.miki85.cz/v3/payout/platform_revenue). You can also use `start` and `end` fields to filter any date range!
...
Thank you all for your patience! If you are having any more issues or have any questions about all of this, feel free to DM @geometrically on Discord or [start a support chat](https://support.cosmods.miki85.cz) and we will be happy to help!
