...
Our [Discord server](https://discord.cosmods.miki85.cz) has a brand new channel: #new-projects. A webhook sends a message to this channel every time a new project gets approved. Check it out when you get a chance!
...
We would love to hear any feedback you might have. Feel free to get in contact on [Discord](https://discord.cosmods.miki85.cz), on [Twitter](https://twitter.com/modrinth), and on [Mastodon](https://floss.social/@modrinth).
