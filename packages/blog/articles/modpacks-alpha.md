...
Right next to mods on the site! URLs to modpacks are the same as mods, just with `mod` replaced with `modpacks`, so you can find the search at https://cosmods.miki85.cz/modpacks.
...
[Modrinth format]: https://docs.cosmods.miki85.cz/docs/modpacks/format_definition/
[documentation for creating modpacks]: https://docs.cosmods.miki85.cz/docs/modpacks/creating_modpacks/
[documentation for playing modpacks]: https://docs.cosmods.miki85.cz/docs/modpacks/playing_modpacks/
