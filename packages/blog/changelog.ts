...
- Backups now correctly show the user who created them.`,
	},
	{
		...
		product: 'hosting',
		body: `## Added
- You can now share access to the server panel through the Access tab. For more information [see the blogpost here](https://cosmods.miki85.cz/news/article/server-access/).`,
	},
	{
...
- Fixed failing to fetch analytics for an obscene amount of projects.`,
	},
	{
		...
		product: 'web',
		body: `## Changed
- Completely overhauled project analytics. See our [blog post](https://cosmods.miki85.cz/news/article/analytics-overhaul/) to learn about it!
...
- Added limits for creating content on Modrinth
	...
	- If you need more, please contact [support](https://support.cosmods.miki85.cz) and explain why, and we can increase your limits.`,
	},
	{
		date: `2025-09-29T12:50:00-07:00`,
		product: 'app',
...
- Fix missing dropdown icon in publishing checklist.`,
	},
	{
		...
		product: 'web',
		body: `### Added
- Reverted Modrinth Pizza due to issues in pizza processing leading to users being redirected to [this page](https://cosmods.miki85.cz/pizza/error).
...
- You can now send someone a link to the download interface with a specific version and loader selected, like so: https://cosmods.miki85.cz/mod/sodium?version=1.21.2&loader=quilt#download (Contributed by [AwakenedRedstone](https://github.com/modrinth/code/pull/3138))`,
	},
	{
