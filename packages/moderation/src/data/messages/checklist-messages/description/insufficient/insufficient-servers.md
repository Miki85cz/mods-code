...
Check out descriptions like [Flatnet](https://cosmods.miki85.cz/server/flatnet) or [Cobblemon Islands](https://cosmods.miki85.cz/server/cobblemon-islands-server) for inspiration when creating a quality and informative description.
